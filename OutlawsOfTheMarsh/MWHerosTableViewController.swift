...
class MWHerosTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = data.name
            //        cell.detailTextLabel?.text = dict.objectForKey("nick")! as? String
        cell.imageView?.image = UIImage(named: data.picName, inBundle: NSBundle.mainBundle(), compatibleWithTraitCollection: UITraitCollection?())
